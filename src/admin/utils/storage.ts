...
const SCHOOL_DATA_VERSION = 'luzie-drift-v1';
...
const defaultNews: NewsItem[] = [
  {
    id: '1',
    title: 'Welcome to Luzie Drift SSS',
    date: 'Now open',
    content:
      'Applications for admissions for the academic year are now open. Luzie Drift Senior Secondary School welcomes learners from the surrounding community.',
    image: '',
  },
];
...
const defaultContact: ContactInfo = {
  address: 'Luzie Drift, Mt Fletcher (Tlokoeng), Eastern Cape, South Africa',
  phone: 'Contact school for phone number',
  email: 'Contact school for email',
  monThu: '07:30 - 15:30',
  friday: '07:30 - 13:30',
  weekend: 'Closed',
};
...
const defaultAbout: AboutInfo = {
  historyParagraphs: [
    'Luzie Drift Senior Secondary School is a public no-fee senior secondary school situated in the Luzie Drift area of Mt Fletcher (officially renamed Tlokoeng in 2022), in the Eastern Cape province of South Africa.',
    'The school serves as a cornerstone of education in the wider Elundini Local Municipality community, providing secondary education to learners from the surrounding rural areas. As a no-fee school, Luzie Drift SSS ensures that every learner in the community has access to quality education regardless of economic circumstances.',
    'The school operates under the auspices of the Joe Gqabi Education District and the Eastern Cape Department of Education. Guided by a dedicated team of educators, learners are nurtured to reach their full potential in line with our motto "Strive to Excel".',
  ],
  principalName: 'Mr. X.L. Nyume',
  principalTitle: 'Principal',
  principalMessage: [
    'Welcome to Luzie Drift Senior Secondary School. Our motto "Strive to Excel" encapsulates our dedication to academic achievement, personal development, and community upliftment.',
    'We believe every learner carries within them the capacity for greatness. Our role is to unlock it — through discipline, dedication, and unwavering belief in their potential.',
  ],
};
